  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-premium hover:shadow-glow font-display font-semibold tracking-wide",
        premium: "bg-gradient-to-r from-primary to-[hsl(var(--primary-glow))] text-primary-foreground shadow-premium hover:shadow-glow font-display font-semibold tracking-wide bg-[length:200%_100%] hover:bg-[position:100%_0] transition-[background-position,box-shadow] duration-500",
      },
      size: {
